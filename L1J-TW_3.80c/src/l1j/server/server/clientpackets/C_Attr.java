		...
		case 479: // 提昇能力值？（str、dex、int、con、wis、cha）
			if (readC() == 1) {
				...
				if (s.toLowerCase().equals("str".toLowerCase())) {
					if (pc.getBaseStr() < Config.BONUS_STATS1) { // 調整能力值上限 
					...
					if (pc.getBaseDex() < Config.BONUS_STATS1) { // 調整能力值上限 
					...
					if (pc.getBaseCon() < Config.BONUS_STATS1) { // 調整能力值上限 
					...
					if (pc.getBaseInt() < Config.BONUS_STATS1) { // 調整能力值上限 
					...
					if (pc.getBaseWis() < Config.BONUS_STATS1) { // 調整能力值上限 
					...
					if (pc.getBaseCha() < Config.BONUS_STATS1) {// 調整能力值上限 
