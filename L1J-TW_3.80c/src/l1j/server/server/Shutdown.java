...
public class Shutdown extends Thread {
	...
	private static String[] _modeText = { "【管理員手動關閉】", "【GM 關閉】","【GM 重新啟動】", "aborting" };
	...
	private void saveData() {
		...
		case SIGTERM:
			...
			break;
		case GM_SHUTDOWN:
			System.err.println("★GM關閉伺服器★");
			break;
		case GM_RESTART:
			System.err.println("★GM重新啟動伺服器★");
			break;
		...
		System.err.println("【資料儲存完畢，所有玩家全部離線。】");
		try {
			int delay = 500;
			Thread.sleep(delay);
		} catch (InterruptedException e) {
