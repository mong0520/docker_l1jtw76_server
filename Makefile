...
deploy:
	@aws ecs update-service --cluster neil-poc --servic l1jtw-service --task-definition first-run-task-definition --desired-count $(COUNT) --network-configuration "awsvpcConfiguration={subnets=[subnet-33ebd445,subnet-28681770],securityGroups=[sg-07f6bec33de7a1662],assignPublicIp=ENABLED}" --force-new-deployment
